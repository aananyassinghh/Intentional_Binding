...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\anany\\Desktop\\LAB\\Intentional Binding\\Intentional Binding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    polygon_2 = visual.ShapeStim(
        ...
        size=(0.2, 0.2), vertices='circle',
        ori=0.0, pos=(0, 0), anchor='center',
        lineWidth=1.0,     colorSpace='rgb',  lineColor=[-1.0000, -0.1765, -1.0000], fillColor=[-1.0000, -0.1765, -1.0000],
